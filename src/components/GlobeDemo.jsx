...
export function GlobeDemo() {
  ...
  return (
    (<div
      className="flex flex-row items-center justify-center py-20 h-screen md:h-auto dark:bg-black bg-[#120C18] relative w-full">
      <div
        ...
        <div
          className="absolute w-full bottom-0 inset-x-0 h-40 bg-gradient-to-b pointer-events-none select-none from-transparent dark:to-black to-[#120C18] z-40" />
